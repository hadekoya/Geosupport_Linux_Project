...
{ "FUNCTION 1E FIELDS FILLER       ", 14, 158, 0, 0, 0, 0, ' ', ' ' }, 
...
{ "UNDERLYING HNS                  ", 11, 274, 0, 0, 0, 0, ' ', ' ' }, 
{ "TRUE B7SC                       ", 8, 285, 0, 0, 0, 0, ' ', ' ' }, 
{ "SEGMENT ID                      ", 7, 293, 0, 0, 0, 0, ' ', ' ' }, 
{ "CURVE FLAG                      ", 1, 300, 0, 0, 0, 0, ' ', ' ' }, 
}; 

int n_wa2_f1e_field_recs = sizeof(wa2_f1e_fld_strs) / sizeof(FIELDENTRY); 
//PFIELDENTRY wa2_f1e_flds = &wa2_f1e_fld_strs; 
PFIELDENTRY wa2_f1e_flds = (PFIELDENTRY)wa2_f1e_fld_strs; 
