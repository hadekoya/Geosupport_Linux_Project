...
int n_wa2_fbn_field_recs = sizeof(wa2_fbn_fld_strs) / sizeof(FIELDENTRY); 
//PFIELDENTRY wa2_fbn_flds = &wa2_fbn_fld_strs; 
PFIELDENTRY wa2_fbn_flds = (PFIELDENTRY)wa2_fbn_fld_strs; 
