...
{ "LIST OF GEOGRAPHIC IDENTIFIERS  ", 2436, 365, 21, 116, 50, 58, ' ', ' ' }, 
...
int n_wa2_f1ax_field_recs = sizeof(wa2_f1ax_fld_strs) / sizeof(FIELDENTRY); 
//PFIELDENTRY wa2_f1ax_flds = &wa2_f1ax_fld_strs; 
PFIELDENTRY wa2_f1ax_flds = (PFIELDENTRY)wa2_f1ax_fld_strs; 
