...
int n_wa2_fbnx_field_recs = sizeof(wa2_fbnx_fld_strs) / sizeof(FIELDENTRY); 
//PFIELDENTRY wa2_fbnx_flds = &wa2_fbnx_fld_strs; 
PFIELDENTRY wa2_fbnx_flds = (PFIELDENTRY)wa2_fbnx_fld_strs; 
