...
{ "LIST OF GEOGRAPHIC IDENTIFIERS  ", 1113, 251, 21, 53, 51, 59, ' ', ' ' }, 
...
int n_wa2_fbl_field_recs = sizeof(wa2_fbl_fld_strs) / sizeof(FIELDENTRY); 
//PFIELDENTRY wa2_fbl_flds = &wa2_fbl_fld_strs; 
PFIELDENTRY wa2_fbl_flds = (PFIELDENTRY)wa2_fbl_fld_strs; 
